...
import { Home, MessageSquare, History, Settings, Wallet } from "lucide-react";
    ...
    <aside className="flex h-full w-56 shrink-0 flex-col border-r border-[var(--ar-border)] bg-[var(--ar-surface)] p-4 backdrop-blur-xl">
      ...
      <div className="mt-auto space-y-2 border-t border-[var(--ar-border)] pt-4">
        <button
          ...
          className="flex w-full items-center gap-2 rounded-xl border border-[var(--ar-border)] bg-[var(--ar-input-bg)] px-3 py-2.5 text-left text-xs text-[var(--ar-fg)] transition hover:border-[#7C4DFF]/40"
        >
