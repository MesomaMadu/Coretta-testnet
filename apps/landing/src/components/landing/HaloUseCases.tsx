...
export default function HaloUseCases() {
  return (
    <section id="how" className="bg-[#F5F5F5] px-6 py-24">
      <div className="mx-auto grid max-w-[88rem] grid-cols-1 items-start gap-8 md:grid-cols-2">
        <div className="md:pr-12 md:pt-2">
          <p className="mb-2 text-sm text-black/60">{BRAND_NAME} in practice</p>
          <h2
        ...
        <div className="relative min-h-[720px] overflow-hidden rounded-3xl">
          <video
            ...
            playsInline
          >
            <source src={USE_VIDEO} type="video/mp4" />
          </video>
          <div
            className="pointer-events-none absolute inset-0"
            style={{
              background:
                "linear-gradient(180deg, rgba(245,245,245,0.75) 0%, rgba(245,245,245,0.35) 45%, rgba(43,38,68,0.25) 100%)",
            }}
            aria-hidden
          />
